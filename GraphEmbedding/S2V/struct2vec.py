...
class Struc2Vec():
    ...
    def train(self, embed_size=32, window_size=5, workers=3, iter=5):
        ...
        # temp_path = mkstemp("data/model/gensim_temp")  # 创建一个temp文件
        # model.save(temp_path)  # 保存模型
        # model = gensim.models.Word2Vec.load('/home/admin1/Jason/socialCoef/data/model/newmodel')
